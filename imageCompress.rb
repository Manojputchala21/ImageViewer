...
data= [
  ["Image URL", "Dimensions", "Original Size","Webp", "50x50","50x50(webp)", "100x100","100x100(webp)" ,"200x200","200x200(webp)", "300x300","300x300(webp)"]
]

csv_file_path = "/Users/manoj/Downloads/Image_urls_part.csv"
export_csv_path = "image_report_part.csv" 
...
CSV.foreach(csv_file_path) do |row|
  ...
  begin
    ...
    sizes.each do |img_size|
      ...
      data_record.push(resize_file_size)
